...
- `qa/web-and-app-mobile-comparison.png` documents the earlier mobile comparison. Portal clienți now renders the dashboard at its native image ratio, without cropping or stretching.
